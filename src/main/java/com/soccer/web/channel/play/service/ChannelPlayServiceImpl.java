...
public class ChannelPlayServiceImpl implements ChannelPlayService {
	...
	@Override
	public List<ChannelPlayVO> selectApplyingChannelPlayList() throws Exception{
		return channelPlayMapper.selectApplyingChannelPlayList();
	}

	@Override
	public void updateChannelPlayApplyOk(int channelPlayIdx) throws Exception {
		channelPlayMapper.updateChannelPlayApplyOk(channelPlayIdx);
	}

	@Override
	public void deleteChannelPlayApply(int channelPlayIdx) throws Exception {
		channelPlayMapper.deleteChannelPlayApply(channelPlayIdx);
	}
	
	@Override
	public List<TeamVO> selectNotLinkedTeamList(int channelPlayIdx) throws Exception {
		return channelPlayMapper.selectNotLinkedTeamList(channelPlayIdx);
	}
}
