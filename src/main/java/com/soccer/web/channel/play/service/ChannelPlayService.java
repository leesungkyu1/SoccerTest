...
public interface ChannelPlayService {
	...
	List<ChannelPlayVO> selectApplyingChannelPlayList() throws Exception;
	
	void updateChannelPlayApplyOk(int channelPlayIdx) throws Exception;
	
	public void deleteChannelPlayApply(int channelPlayIdx) throws Exception;

	List<TeamVO> selectNotLinkedTeamList(int channelPlayIdx) throws Exception;
}
