...
public class TeamPlayerController {
	...
	@RequestMapping(value = "channel/{channelIdx}/play/{channelPlayIdx}/member", method = RequestMethod.GET)
	public String selectMemberList(@PathVariable int channelPlayIdx) {
		// TODO 페이지에 들어왔을 때 멤버 리스트를 출력
		return null;
	}
	
	// 영상 게시글에서 Player를 추가하는 메서드
	@RequestMapping(value = "channel/{channelIdx}/play/{channelPlayIdx}/member", method = RequestMethod.POST)
	...
	@RequestMapping(value = "channel/{channelIdx}/play/{channelPlayIdx}/member", method = RequestMethod.PUT)
	...
	@RequestMapping(value = "channel/{channelIdx}/play/{channelPlayIdx}/member", method = RequestMethod.DELETE)
	...
	@RequestMapping(value = "channel/{channelIdx}/play/{channelPlayIdx}/player/{teamPlayerIdx}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "channel/{channelIdx}/play/{channelPlayIdx}/player", method = RequestMethod.PUT)
	public String updatePlayresult(	RedirectAttributes attributes,
		...
		return "redirect:/channel/{channelIdx}/play/channelPlayIdx}/player";
	}
